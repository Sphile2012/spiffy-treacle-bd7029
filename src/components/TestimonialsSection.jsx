  ...
  return (
    <section className="py-24 px-4 sm:px-6 bg-secondary/30">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h3 className="font-heading text-2xl sm:text-3xl font-bold mb-4">Ready to glow?</h3>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="https://wa.me/27798060310?text=Hi%20She%20Is%20The%20Best!%20I'd%20like%20to%20enquire." target="_blank" rel="noopener noreferrer">
