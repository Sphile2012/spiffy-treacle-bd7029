...
export default function BookingConfirmed() {
  ...
  const emailUrl = `mailto:poomeigh503@gmail.com?subject=${encodeURIComponent(emailSubject)}&body=${encodeURIComponent(emailBody)}`;
  ...
  return (
    <div className="py-16 px-4 sm:px-6 min-h-[80vh] flex items-center justify-center bg-gradient-to-b from-violet-50/40 to-background">
      <motion.div
      ...
      >
        <div className="bg-white rounded-3xl shadow-xl border border-violet-100 overflow-hidden">
          ...
          {/* Header */}
          <div className="bg-gradient-to-r from-[#6f40bf] to-[#b090d0] px-8 py-10 text-center">
            <motion.div
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
          ...
          <div className="px-7 py-7 space-y-5">
            ...
            {/* Summary */}
            <div className="bg-violet-50/60 border border-violet-100 rounded-2xl p-5 space-y-3 text-sm">
              <p className="text-xs font-semibold uppercase tracking-wider text-[#6f40bf] flex items-center gap-1.5">
              ...
              <div className="space-y-2 text-foreground">
                ...
                {booking.price > 0 && (
                  <div className="flex justify-between pt-2 border-t border-violet-200">
                    ...
                    <span className="font-bold text-[#6f40bf] text-base">R{booking.price}</span>
                  </div>
                )}
              </div>
            </div>
        ...
        <p className="text-center text-xs text-muted-foreground mt-5">
          ...
          <a href="https://wa.me/27823562239" className="text-[#6f40bf] font-medium">
            082 356 2239
          </a>
        </p>
      </motion.div>
